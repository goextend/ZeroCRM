...
// Documentation: https://goextend.io/docs/discovering-extensions
exports.discoverExtensions = (webtaskContext, extensibilityPoint, cb) => {
    return superagent.get(`${config.hostUrl}/api/webtask/${webtaskContext.webtaskContainer}`)
...
exports.invokeExtension = (extensions, payload, cb) => {
    ...
    const secret = extension.meta['wt-auth-secret'] || extension.meta['auth0-extension-secret'];
